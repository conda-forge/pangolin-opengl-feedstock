About pangolin-opengl-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pangolin-opengl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pangolin-opengl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pangolin-opengl
# for installing globally
pixi global install pangolin-opengl
```
...
It is possible to list all of the versions of `pangolin-opengl` available on your platform:
...
```
pixi search pangolin-opengl --channel conda-forge
```
